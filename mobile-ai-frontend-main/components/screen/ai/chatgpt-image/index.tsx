...
import { useGenerate } from "@/hooks/useChatGPTImage";
import { saveGeneratedImageToGallery } from "@/helpers/app-functions";
...
const ReplicateAI = () => {
  ...
  const handleGenerateImage = async () => {
    await generateImage(prompt, { provider: "image" });
  };
  ...
  return (
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
      ...
      >
        ...
        >
          <View style={{ gap: 16 }}>
            <ThemedText type="title">ChatGPT Image</ThemedText>
